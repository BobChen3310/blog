...
const config: SiteConfig = {
  ...
  site: 'https://blog.bob0623.net',
  // The name of your site, used in the title and for SEO.
  title: "Bob's Blog",
  // The description of your site, used for SEO and RSS feed.
  description: 'Bob 的個人部落格，專注於技術文章與日常分享',
  // The author of the site, used in the footer, SEO, and RSS feed.
  author: 'BobChen',
  // Keywords for SEO, used in the meta tags.
  tags: ['Astro', 'Blog', 'Bob', 'Guide', 'Tech', 'Network', 'DN42', 'BGP', 'AS211749', 'Linux', 'Server', '部落格', '指南', '技術', '網路技術', '路由', '伺服器', '日常'],
  ...
  // giscus: undefined,
  giscus: {
    repo: 'BobChen3310/giscus',
    repoId: 'R_kgDOQkIrXQ',
    category: 'General',
    categoryId: 'DIC_kwDOQkIrXc4Czfvv',
